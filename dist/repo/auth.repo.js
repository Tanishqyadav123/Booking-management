...
exports.fetchUserProfileService = exports.createNewUserService = exports.isUserExistWithEmailOrPhoneService = exports.isPhoneNumberVerifiedService = exports.markAsVerifiedService = exports.verifyOtpService = exports.upsertVerificationCodeService = void 0;
...
const createNewUserService = async (createNewUserDetails) => await client_1.prisma.user.create({
    data: {
